...
public class AlbumJacksonTest {
    ...
    public void test_Default_Behavior_Of_Object_Mapping() throws Exception {
        ...
        assertThat(jsonArtist, Matchers.not(Matchers.containsString("1926")));
    }

    @Test
    public void test_Indent_Output_Behavior_Of_Object_Mapping() throws JsonProcessingException {
    ...
    @Test
    public void test_Date_Format_Behavior_Of_Object_Mapping() throws JsonProcessingException {

        // Given
        this.objectMapper.setDateFormat(new SimpleDateFormat("dd MMM yyyy"));
    ...
    public void test_Not_Include_Empty_Fields() throws Exception {
        ...
        System.out.println(jsonArtist);
        assertThat(jsonArtist, Matchers.containsString("\"age\":0"));
        assertThat(jsonArtist, Matchers.not(Matchers.containsString("homeTown")));
        assertThat(jsonArtist, Matchers.not(Matchers.containsString("awardsWon")));
    }
